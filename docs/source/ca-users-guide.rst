...
The following links shows the :doc:`Server Command Line <ca-servercli>` and
:doc:`Client Command Line <ca-clientcli>`.
...
link shows a sample :doc:`Server configuration file <ca-serverconfig>`.
...
link shows a sample :doc:`Client configuration file <ca-clientconfig>`.
